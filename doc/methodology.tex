...
Some of the most used approach are the Generalized Maximum Entropy (GME) 
 andthe  Generalized Cross Entropy (GCE) techniques \cite{Robinson2000}, \cite{Britz2002},
...
cell conditionally to the constrains,  and for this reason is high memory demanding 
and the speed depend on the table  dimension. For these reason, and for the 
